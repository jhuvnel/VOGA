...
for i = 1:height(tab_LA)
    if tab_LA.Date(i)==datetime(2025,11,22)
        col = '#b3cde3';
    elseif tab_LA.Date(i)==datetime(2025,12,06)
        col = '#8c96c6';
    elseif tab_LA.Date(i)==datetime(2025,12,11)
        col = '#8856a7';
    end
...
%     table2array(tab_LA(10:18,'MaxEyeMovement_R'))';
%     table2array(tab_LA(19:27,'MaxEyeMovement_R'))';]';
% y_sd = [table2array(tab_LA(1:9,'MaxEyeMovement_R_sd'))';
%     table2array(tab_LA(10:18,'MaxEyeMovement_R_sd'))';
%     table2array(tab_LA(19:27,'MaxEyeMovement_R_sd'))']';
% Right eye
% y = [table2array(tab_LA(1:9,'MaxEyeMovement_R'))';
...
% x(7) =[];
y = [table2array(tab_LA(1:8,'MaxEyeMovement_R'))';
    table2array(tab_LA(9:16,'MaxEyeMovement_R'))';
    table2array(tab_LA(17:24,'MaxEyeMovement_R'))';]';
y_sd = [table2array(tab_LA(1:8,'MaxEyeMovement_R_sd'))';
    table2array(tab_LA(9:16,'MaxEyeMovement_R_sd'))';
    table2array(tab_LA(17:24,'MaxEyeMovement_R_sd'))']';
