...
for numfiles = 1:length(chairfiles)
    ...
    prompt = {'Left eye theta:','Left eye y_0:','Left eye z_0:','Right eye theta (negative by RHR):','Right eye y_0:','Right eye z_0:'};
    ...
    cal_data = [str2num(dlganswer{2}) str2num(dlganswer{3}) str2num(dlganswer{1}); str2num(dlganswer{5}) str2num(dlganswer{6}) -abs(str2num(dlganswer{4}))];
    if savefile
