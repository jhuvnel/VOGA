function Data = CombineSegments(Data1,Data2)
    ...
    if contains(Data.info.goggle_ver,'GNO')
        Data.RE_Vel_Y = [Data1.RE_Vel_Y;Data2.RE_Vel_Y];
        Data.RE_Vel_Z = [Data1.RE_Vel_Z;Data2.RE_Vel_Z];
        Data.HeadVel_Z = [Data1.HeadVel_Z;Data2.HeadVel_Z];
        Data.HeadVel_L = [Data1.HeadVel_L;Data2.HeadVel_L];
        Data.HeadVel_R = [Data1.HeadVel_R;Data2.HeadVel_R];
    else
