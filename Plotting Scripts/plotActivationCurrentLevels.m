%% Plot 3D Alignment
%This code is not functional and will be imported to another function
load('VNELcolors.mat','colors')
fnames = unique(extractfield([dir([Cyc_Path,filesep,'*CurrentFitting*.mat']);dir([Cyc_Path,filesep,'*Autoscan*.mat'])],'name'));
hg = figure;
