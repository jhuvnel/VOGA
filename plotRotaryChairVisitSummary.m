...
% plots = 0, all
% plots = 1, just cyc averages for all frequencies by exp type 
% plots = 2, just gain/phase over freq for all exp type

function plotRotaryChairVisitSummary(plots,path,Cyc_Path,code_Path,version,Experimenter)
